...
function turn_down_word.processor(key, env)
...
function turn_down_word.filter(input, env)
...
return {
    processor = { func = turn_down_word.processor },
    filter = turn_down_word.filter,
}
